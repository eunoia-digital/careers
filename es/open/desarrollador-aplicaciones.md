...
Buscamos un desarrollador de aplicaciones android y iOS para responsabilizarse de las siguientes tareas:
* Diseñar y construir aplicaciones nativas.
...
* Desarrollo de aplicaciones android y iOS nativas.
* Publicar aplicaciones en la Google Play Store y la Apple App Store.
